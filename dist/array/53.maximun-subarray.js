...
var maxSubArray2 = function maxSubArray2(nums) {
  if (!nums) {
    throw 'error';
  }
...
var maxSubArray3 = function maxSubArray3(nums) {
  if (!nums) {
    throw 'error';
  }
...
var maxSubArray4 = function maxSubArray4(nums, i) {
...
var maxSubArray5 = function maxSubArray5(nums) {
  var pd = [];
  pd[0] = nums[0];
...
//# sourceMappingURL=53.maximun-subarray.js.map